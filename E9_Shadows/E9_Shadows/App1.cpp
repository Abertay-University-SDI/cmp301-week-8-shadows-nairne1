...
void App1::gui()
{
	...
	ImGui::SliderFloat3("Light 1 Position", position, -50.f, 50.f);//control light position with sliders
	...
	ImGui::SliderFloat3("Light 1 Direction", direction, -50.f, 50.f);//control light position with sliders
